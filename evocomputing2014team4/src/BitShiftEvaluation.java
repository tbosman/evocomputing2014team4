...
public class BitShiftEvaluation implements ContestEvaluation 
{
	// Evaluations budget
	...
	private final static double BASE_ = 240.2496;//= E[] = -4.5736711112154325;
	...
	{	
		...
		for(int i=0; i<10;i++) {
			long l = Double.doubleToLongBits(x[i]);
